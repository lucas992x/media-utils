This repository contains some utilities for multimedia files, written in Bash; some of them require [FFmpeg](http://ffmpeg.org/), others require [ImageMagick](https://imagemagick.org/).
